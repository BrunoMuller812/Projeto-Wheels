...
// import MainLayout from '../../components/layout/MainLayout'; // REMOVIDO
import LoadingSpinner from '../../components/common/LoadingSpinner';
import { showConfirmation, showSuccess, showError } from '../../utils/notifications';

// Sub-componente para o Modal de Cadastro
    ...
    return (
        <div style={pageStyles.container}>
            <div style={pageStyles.header}>
                ...
                <button onClick={() => setShowModal(true)} style={pageStyles.addButton}>+ Adicionar Bicicleta</button>
            </div>
            <p style={pageStyles.description}>Adicione novas bicicletas ou gerencie as devoluções das que estão em uso.</p>
            {renderContent()}
            <AddBikeModal show={showModal} onClose={() => setShowModal(false)} onBikeAdded={fetchData} />
        </div>
    );
}
...
const pageStyles = {
    ...
    title: { fontSize: '2.5em', color: '#2c3e50', margin: 0 },
