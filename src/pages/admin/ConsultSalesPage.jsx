...
// O import do MainLayout foi REMOVIDO daqui.
...
function ConsultSalesPage() {
    ...
    // O retorno agora é apenas a div principal, SEM o MainLayout em volta.
    return (
...
const pageStyles = {
    ...
    title: { 
        fontSize: '2.5em', color: '#2c3e50', marginBottom: '15px' 
    },
    description: { 
