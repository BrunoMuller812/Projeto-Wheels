...
// --- SUB-COMPONENTE DE BUSCA (COM A CORREÇÃO) ---
        ...
        <div style={formStyles.formContainer}>
            ...
            {selectedCustomer && (
                <div style={formStyles.customerDetails}>
                    ...
                    {/* AQUI ESTÁ A CORREÇÃO QUE IMPEDE A TELA BRANCA */}
...
// --- SUB-COMPONENTE DE SELEÇÃO DE BIKE ---
const BikeSelection = ({ customer }) => {
    ...
    if (!customer) {
        return <p>Erro: dados do cliente não encontrados. Por favor, volte e selecione o cliente novamente.</p>;
    }
